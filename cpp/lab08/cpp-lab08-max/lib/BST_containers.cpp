...
template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::Node* BST_InOrder<T, C, A>::minimum(Node* n) {
	while (n && n->left) n = n->left;
	return n;
}

template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::Node* BST_InOrder<T, C, A>::maximum(Node* n) {
...
BST_InOrder<T, C, A>::insert(const T& v) {
	...
	while (cur) {
		...
		if (comp_(v, cur->data))
			cur = cur->left;
		else if (comp_(cur->data, v))
			cur = cur->right;
		else
			return {{cur, root_}, false};
	}
	Node* n = alloc_.allocate(1);
	std::allocator_traits<NodeAlloc>::construct(alloc_, n, v);
	n->parent = parent;
	if (comp_(v, parent->data))
		parent->left = n;
	else
		parent->right = n;
	++sz_;
...
template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::iterator BST_InOrder<T, C, A>::find(
	const T& v) const {
	Node* cur = root_;
	while (cur) {
		if (comp_(v, cur->data))
...
template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::size_type BST_InOrder<T, C, A>::count(
	const T& v) const {
	return find(v) != cend();  // use cend() here for const-correctness
}

template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::size_type BST_InOrder<T, C, A>::size() const {
	return sz_;
}
...
template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::iterator BST_InOrder<T, C, A>::begin() {
	return {minimum(root_), root_};
}

template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::iterator BST_InOrder<T, C, A>::end() {
	return {nullptr, root_};
}

template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::const_iterator BST_InOrder<T, C, A>::cbegin()
	const {
	return {minimum(root_), root_};
}

template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::const_iterator BST_InOrder<T, C, A>::cend()
	const {
	return {nullptr, root_};
}

template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::reverse_iterator BST_InOrder<T, C, A>::rbegin() {
	return reverse_iterator(end());
}

template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::reverse_iterator BST_InOrder<T, C, A>::rend() {
	return reverse_iterator(begin());
}

// iterator
template <typename T, typename C, typename A>
BST_InOrder<T, C, A>::iterator::iterator(Node* n, Node* root)
	: node_(n), root_(root) {}
...
template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::Node* BST_InOrder<T, C, A>::iterator::minimum(
	typename BST_InOrder<T, C, A>::Node* n) {
	while (n->left) n = n->left;
	return n;
}

template <typename T, typename C, typename A>
typename BST_InOrder<T, C, A>::Node* BST_InOrder<T, C, A>::iterator::maximum(
	typename BST_InOrder<T, C, A>::Node* n) {
...
template <typename T, typename C, typename A>
void BST_PreOrder<T, C, A>::clear_node(
	typename BST_PreOrder<T, C, A>::Node* n) {
	if (!n) return;
	clear_node(n->left);
	clear_node(n->right);
	std::allocator_traits<typename BST_PreOrder<T, C, A>::NodeAlloc>::destroy(
		alloc_, n);
	alloc_.deallocate(n, 1);
}
...
template <typename T, typename C, typename A>
typename BST_PreOrder<T, C, A>::iterator BST_PreOrder<T, C, A>::find(
	const T& v) const {
	Node* cur = root_;
	while (cur) {
		if (comp_(v, cur->data))
...
template <typename T, typename C, typename A>
typename BST_PreOrder<T, C, A>::size_type BST_PreOrder<T, C, A>::count(
	const T& v) const {
	return find(v) != cend();  // use cend() here
}

template <typename T, typename C, typename A>
typename BST_PreOrder<T, C, A>::size_type BST_PreOrder<T, C, A>::size() const {
	return sz_;
}
...
template <typename T, typename C, typename A>
typename BST_PreOrder<T, C, A>::iterator BST_PreOrder<T, C, A>::begin() {
	return {root_};
}

template <typename T, typename C, typename A>
typename BST_PreOrder<T, C, A>::iterator BST_PreOrder<T, C, A>::end() {
	return {nullptr};
}

template <typename T, typename C, typename A>
typename BST_PreOrder<T, C, A>::const_iterator BST_PreOrder<T, C, A>::cbegin()
	const {
	return {root_};
}

template <typename T, typename C, typename A>
typename BST_PreOrder<T, C, A>::const_iterator BST_PreOrder<T, C, A>::cend()
	const {
	return {nullptr};
}
...
template <typename T, typename C, typename A>
typename BST_PreOrder<T, C, A>::reverse_iterator BST_PreOrder<T, C, A>::rend() {
	return reverse_iterator(begin());
}

// iterator
template <typename T, typename C, typename A>
BST_PreOrder<T, C, A>::iterator::iterator(Node* n) : node_(n) {}
...
// pre-order next
template <typename T, typename C, typename A>
typename BST_PreOrder<T, C, A>::Node* BST_PreOrder<T, C, A>::iterator::next_pre(
	Node* n) {
	if (!n) return nullptr;
	if (n->left) return n->left;
	if (n->right) return n->right;
	while (n->parent) {
		if (n == n->parent->left && n->parent->right) return n->parent->right;
		n = n->parent;
	}
	return nullptr;
}
...
template <typename T, typename C, typename A>
typename BST_PreOrder<T, C, A>::Node* BST_PreOrder<T, C, A>::iterator::prev_pre(
	Node* n) {
	return nullptr;
}
...
template <typename T, typename C, typename A>
void BST_PostOrder<T, C, A>::clear_node(
	typename BST_PostOrder<T, C, A>::Node* n) {
	if (!n) return;
	clear_node(n->left);
	clear_node(n->right);
	std::allocator_traits<typename BST_PostOrder<T, C, A>::NodeAlloc>::destroy(
		alloc_, n);
	alloc_.deallocate(n, 1);
}
...
template <typename T, typename C, typename A>
typename BST_PostOrder<T, C, A>::iterator BST_PostOrder<T, C, A>::find(
	const T& v) const {
	Node* cur = root_;
	while (cur) {
		if (comp_(v, cur->data))
...
template <typename T, typename C, typename A>
typename BST_PostOrder<T, C, A>::size_type BST_PostOrder<T, C, A>::count(
	const T& v) const {
	return find(v) != cend();  // use cend() here
}

template <typename T, typename C, typename A>
typename BST_PostOrder<T, C, A>::size_type BST_PostOrder<T, C, A>::size()
	const {
	return sz_;
}
...
template <typename T, typename C, typename A>
typename BST_PostOrder<T, C, A>::iterator BST_PostOrder<T, C, A>::begin() {
	return {iterator::first_post(root_), root_};  // qualify first_post
}

template <typename T, typename C, typename A>
typename BST_PostOrder<T, C, A>::iterator BST_PostOrder<T, C, A>::end() {
	return {nullptr, root_};
}

template <typename T, typename C, typename A>
typename BST_PostOrder<T, C, A>::const_iterator BST_PostOrder<T, C, A>::cbegin()
	const {
	return {iterator::first_post(root_), root_};  // qualify first_post
}

template <typename T, typename C, typename A>
typename BST_PostOrder<T, C, A>::const_iterator BST_PostOrder<T, C, A>::cend()
	const {
	return {nullptr, root_};
}
...
// iterator
template <typename T, typename C, typename A>
BST_PostOrder<T, C, A>::iterator::iterator(Node* n, Node* root)
	: node_(n), root_(root) {}
...
BST_PostOrder<T, C, A>::iterator::operator--() {
	if (!node_)
		node_ = first_post(root_);
	else
		node_ = prev_post(node_, root_);
	return *this;
}
